...
4. One item per row. Split qty lines (`2 Mojitos $26` → two `$13` Mojito rows). Round each split to cents; leftover penny goes on the last row.
...
7. Tax, tip, and discount split proportionally by each person's subtotal.
